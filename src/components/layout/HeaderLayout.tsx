...
const HeaderLayout = () => {
  ...
  return (
    <header className="w-full px-4 md:px-10 py-4 bg-dark2 flex items-center justify-between border-b border-dark3">
      ...
      <div className="flex items-center gap-4">
        <Bell className="h-5 w-5 text-white hover:text-green transition" />
